...
enum Theme {
    enum Palette {
        ...
        static let neonCyan = Color(red: 0x00 / 255.0, green: 0xF5 / 255.0, blue: 0xFF / 255.0)
        static let neonPurple = Color(red: 0xBF / 255.0, green: 0x00 / 255.0, blue: 0xFF / 255.0)
        static let neonPink = Color(red: 0xFF / 255.0, green: 0x4F / 255.0, blue: 0xD8 / 255.0)
        static let neonLime = Color(red: 0x39 / 255.0, green: 0xFF / 255.0, blue: 0x14 / 255.0)
        static let neonYellow = Color(red: 0xFF / 255.0, green: 0xF0 / 255.0, blue: 0x1F / 255.0)
        static let neonRed = Color(red: 0xFF / 255.0, green: 0x2D / 255.0, blue: 0x2D / 255.0)
        static let neonOrange = Color(red: 0xFF / 255.0, green: 0x8A / 255.0, blue: 0x00 / 255.0)
        static let neonBlue = Color(red: 0x2F / 255.0, green: 0x6B / 255.0, blue: 0xFF / 255.0)
        static let neonIce = Color(red: 0x6D / 255.0, green: 0xF0 / 255.0, blue: 0xFF / 255.0)
